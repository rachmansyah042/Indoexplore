...
<header>
    ...
    <div class="container">
            <div>  <br>
                <h2 class="section-heading text-center" id="destinasi"> Open Trip</h2>
                <hr>
            </div>
                <div class="row">
                    <div id="outputDestinasi"></div>
        ...
        <div class="container">
            <div>  
                <br>
                <h2 class="section-heading text-center" id="private"> Private Trip </h2>
                <hr>
            </div>
            <div class="row">
